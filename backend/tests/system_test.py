...
async def run_exhaustive_tests():
    test_suite = {
        "en": [
            ...
            ("How can I contact your sales team?", "Sales Team"),
            ("What is your phone number?", "0(324) 404 0 808"),
            ("Can I request a demo?", "Request a Demo"),
            ("How can I contact you?", "Our Office"),
        ...
        "tr": [
            ...
            ("Telefon numaranız nedir?", "0(324) 404 0 808"),
            ("Demo alabilir miyim?", "Demo Talebi"),
            ("Adresiniz nedir?", "Ofisimiz"),
            ...
            ("İletişim bilgileriniz?", "Ofisimiz"),
        ...
        "ar": [
            ...
            ("كيف أتصل بالمبيعات؟", "فريق المبيعات"),
            ("ما هو رقم تليفونكم؟", "0(324) 404 0 808"),
            ("طلب عرض تجريبي", "عرض تجريبي"),
            ("أين يقع مكتبكم؟", "مكتبنا"),
        ...
        "ru": [
            ...
            ("Как связаться с отделом продаж?", "Отдел продаж"),
            ("Какой ваш номер телефона?", "0(324) 404 0 808"),
            ("Можно ли заказать демо?", "Запросить демо"),
            ("Где находится ваш офис?", "Наш офис"),
