...
def _training_data() -> List[IntentExample]:
    ...
    examples += [
        ...
        IntentExample("What is ARI KONAKLAMA?", "ari_konaklama"),
        IntentExample("Tell me about bee accommodation", "ari_konaklama"),
        IntentExample("Tell me about ARI KONAKLAMA and other products", "products"),
        ...
        IntentExample("how can I contact your sales team?", "sales_team"),
        IntentExample("sales department", "sales_team"),
        IntentExample("talk to sales", "sales_team"),
        IntentExample("sales contact", "sales_team"),
        IntentExample("request a demo", "request_demo"),
        IntentExample("can I request a demo?", "request_demo"),
        IntentExample("demo version", "request_demo"),
        IntentExample("How can I get a demo?", "request_demo"),
        IntentExample("What is your phone number?", "phone_number"),
        IntentExample("phone", "phone_number"),
        IntentExample("telephone", "phone_number"),
        IntentExample("call you", "phone_number"),
        IntentExample("contact number", "phone_number"),
        IntentExample("Give me your contact number", "phone_number"),
        ...
        IntentExample("personal data protection", "personal_data_protection"),
        IntentExample("KVKK", "personal_data_protection"),
        IntentExample("GDPR", "personal_data_protection"),
        IntentExample("what is personal data protection", "personal_data_protection"),
        IntentExample("privacy policy", "privacy_policy"),
        IntentExample("how do you handle my data", "privacy_policy"),
        IntentExample("user agreement", "user_agreement"),
        IntentExample("terms of use", "user_agreement"),
        IntentExample("terms and conditions", "user_agreement"),
        IntentExample("information security policy", "info_security_policy"),
        IntentExample("ISO 27001", "info_security_policy"),
        IntentExample("security standards", "info_security_policy"),
        IntentExample("who are your references", "references"),
        IntentExample("which companies do you work with", "references"),
        IntentExample("list of customers", "references"),
        IntentExample("partners", "references"),
        IntentExample("what are you researching", "research_development"),
        IntentExample("R&D projects", "research_development"),
        IntentExample("research and development", "research_development"),
        IntentExample("future projects", "research_development"),
    ...
    examples += [
        ...
        IntentExample("iletişim", "contact_info"),
        IntentExample("iletişim bilgisi", "contact_info"),
        IntentExample("iletişim kanalları", "contact_info"),
        IntentExample("nasıl ulaşırım", "contact_info"),
        IntentExample("bana iletişim bilgisini ver", "contact_info"),
        IntentExample("neredesiniz", "contact_info"),
        IntentExample("ofis neresi", "contact_info"),
        IntentExample("adres neresi", "contact_info"),
        IntentExample("size nasıl ulaşabilirim", "contact_info"),
        IntentExample("iletişim bilgileriniz", "contact_info"),
        IntentExample("iletişim bilgileriniz neler", "contact_info"),
        IntentExample("satış ekibiyle görüşmek istiyorum", "sales_team"),
        IntentExample("satış departmanı", "sales_team"),
        IntentExample("satış temsilcisi", "sales_team"),
        IntentExample("demo talep et", "request_demo"),
        IntentExample("demo istiyorum", "request_demo"),
        IntentExample("ürünü denemek istiyorum", "request_demo"),
        IntentExample("telefon numaranız nedir", "phone_number"),
        IntentExample("numaranız var mı", "phone_number"),
        IntentExample("bizi arayın", "phone_number"),
        ...
        IntentExample("iş ilanlarınız", "career_info"),
        IntentExample("güncel iş ilanları", "career_info"),
        IntentExample("kariyer fırsatları", "career_info"),
        IntentExample("açık pozisyonlar", "career_info"),
        IntentExample("ekibinize katılmak istiyorum", "career_info"),
        IntentExample("başvuru süreci", "career_info"),
        IntentExample("işe alım", "career_info"),
        IntentExample("işe alımları", "career_info"),
        IntentExample("işe alım var mı", "career_info"),
        IntentExample("eleman alıyor musunuz", "career_info"),
        IntentExample("personel alımı", "career_info"),
        IntentExample("iş başvurusu", "career_info"),
        IntentExample("kariyer", "career_info"),
        IntentExample("staj", "career_info"),
        ...
        IntentExample("Arı konaklama nedir", "ari_konaklama"),
        IntentExample("arı konaklama projesi", "ari_konaklama"),
        IntentExample("konaklama noktası tespiti", "ari_konaklama"),
        IntentExample("kişisel verilerin korunması", "personal_data_protection"),
        IntentExample("KVKK politikası", "personal_data_protection"),
        IntentExample("verilerim nasıl korunuyor", "personal_data_protection"),
        IntentExample("gizlilik politikası", "privacy_policy"),
        IntentExample("gizlilik sözleşmesi", "privacy_policy"),
        IntentExample("kullanıcı sözleşmesi", "user_agreement"),
        IntentExample("kullanım koşulları", "user_agreement"),
        IntentExample("bilgi güvenliği politikası", "info_security_policy"),
        IntentExample("ISO 27001 sertifikası", "info_security_policy"),
        IntentExample("güvenlik politikalarınız", "info_security_policy"),
        IntentExample("referanslarınız kimler", "references"),
        IntentExample("kimlerle çalışıyorsunuz", "references"),
        IntentExample("müşteri listesi", "references"),
        IntentExample("referanslar", "references"),
        IntentExample("ar-ge projeleriniz", "research_development"),
        IntentExample("araştırma ve geliştirme", "research_development"),
        IntentExample("gelecek projeler", "research_development"),
    ]
    ...
    examples += [
        ...
        IntentExample("как с вами связаться", "contact_info"),
        IntentExample("связаться с отделом продаж", "sales_team"),
        IntentExample("команда продаж", "sales_team"),
        IntentExample("запросить демо", "request_demo"),
        IntentExample("запрос демо-версии", "request_demo"),
        IntentExample("номер телефона", "phone_number"),
        IntentExample("как позвонить", "phone_number"),
        IntentExample("телефон", "phone_number"),
    ...
    examples += [
        ...
        IntentExample("أريد التواصل مع المبيعات", "sales_team"),
        IntentExample("فريق المبيعات", "sales_team"),
        IntentExample("رقم الهاتف", "phone_number"),
        IntentExample("ما هو رقم تليفونكم؟", "phone_number"),
        IntentExample("طلب عرض تجريبي", "request_demo"),
        IntentExample("تجربة المنتج", "request_demo"),
